...
let ans : string[] = []
let extrovert :string[] = ["hang out with friends","sociable","don't controls emotions" ,"learn through experience ","easily make friends "]
let introvert:string[]= ["live alone","work independently","keep emotion private","learn through observation","very chosse to make friends"]
